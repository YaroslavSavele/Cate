...
const btnPreviews = document.querySelectorAll('.btn__slider');
const pictures = document.querySelectorAll('.card-room__item');
//console.log(btnPreviews);
function hide () {
